...
const config = {
	...
	scene: [/*MainScene, historyScene*//* InstructionScene, selecScene,*/ LevelScene2, LevelScene1, LevelScene3, LevelScene4, LevelSceneBoss ,Hud, StatsScene, SettingScene, GameOverScene],
}
